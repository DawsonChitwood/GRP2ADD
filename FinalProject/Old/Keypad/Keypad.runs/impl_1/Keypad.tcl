namespace eval ::optrace {
  variable script "C:/CSEE4280/GRP2ADD/FinalProject/Keypad/Keypad.runs/impl_1/Keypad.tcl"
...
OPTRACE "set parameters" START { }
  set_property webtalk.parent_dir C:/CSEE4280/GRP2ADD/FinalProject/Keypad/Keypad.cache/wt [current_project]
  set_property parent.project_path C:/CSEE4280/GRP2ADD/FinalProject/Keypad/Keypad.xpr [current_project]
  set_property ip_output_repo C:/CSEE4280/GRP2ADD/FinalProject/Keypad/Keypad.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
OPTRACE "set parameters" END { }
OPTRACE "add files" START { }
  add_files -quiet C:/CSEE4280/GRP2ADD/FinalProject/Keypad/Keypad.runs/synth_1/Keypad.dcp
OPTRACE "read constraints: implementation" START { }
  read_xdc C:/CSEE4280/GRP2ADD/FinalProject/Keypad/Keypad.srcs/constrs_1/new/keypad.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "read constraints: implementation_pre" START { }
OPTRACE "read constraints: implementation_pre" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top Keypad -part xc7a100tcsg324-1 
...
OPTRACE "opt_design reports" START { REPORT }
  ...
  generate_parallel_reports -reports { "report_drc -file Keypad_drc_opted.rpt -pb Keypad_drc_opted.pb -rpx Keypad_drc_opted.rpx"  }
...
OPTRACE "place_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_io -file Keypad_io_placed.rpt" "report_utilization -file Keypad_utilization_placed.rpt -pb Keypad_utilization_placed.pb" "report_control_sets -verbose -file Keypad_control_sets_placed.rpt"  }
  set_param project.isImplRun false
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force Keypad_physopt.dcp
...
OPTRACE "route_design reports" START { REPORT }
  set_param project.isImplRun true
  generate_parallel_reports -reports { "report_drc -file Keypad_drc_routed.rpt -pb Keypad_drc_routed.pb -rpx Keypad_drc_routed.rpx" "report_methodology -file Keypad_methodology_drc_routed.rpt -pb Keypad_methodology_drc_routed.pb -rpx Keypad_methodology_drc_routed.rpx" "report_power -file Keypad_power_routed.rpt -pb Keypad_power_summary_routed.pb -rpx Keypad_power_routed.rpx" "report_route_status -file Keypad_route_status.rpt -pb Keypad_route_status.pb" "report_timing_summary -max_paths 10 -report_unconstrained -file Keypad_timing_summary_routed.rpt -pb Keypad_timing_summary_routed.pb -rpx Keypad_timing_summary_routed.rpx -warn_on_violation " "report_incremental_reuse -file Keypad_incremental_reuse_routed.rpt" "report_clock_utilization -file Keypad_clock_utilization_routed.rpt" "report_bus_skew -warn_on_violation -file Keypad_bus_skew_routed.rpt -pb Keypad_bus_skew_routed.pb -rpx Keypad_bus_skew_routed.rpx"  }
  set_param project.isImplRun false
...
OPTRACE "read constraints: write_bitstream" END { }
  catch { write_mem_info -force -no_partial_mmi Keypad.mmi }
