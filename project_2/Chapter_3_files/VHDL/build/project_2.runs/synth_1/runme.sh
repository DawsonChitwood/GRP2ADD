...
HD_PWD='/home/student/Desktop/CSEE4280/CH3/VHDL/build/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log leading_ones.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source leading_ones.tcl
